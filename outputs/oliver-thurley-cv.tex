...
\subsubsection{\texorpdfstring{\href{https://github.com/thrly/scry}{scry}
(Python, SQL, CLI
Tool)}{scry (Python, SQL, CLI Tool)}}\label{scry-python-sql-cli-tool}

A project to develop skills with data ingestion and database queries in
Python. Leverages the Scryfall API and an SQLite database to view stats
for MTG set releases and custom searches via the command line. Packaged
and released through PyPi index.
